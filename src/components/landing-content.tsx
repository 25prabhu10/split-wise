        ...
        <div className="space-y-8 text-center">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              {isAuthenticated ? <>Welcome back, {userName}!</> : <>Share Expenses Effortlessly</>}
            </h1>
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground sm:text-xl">
              {isAuthenticated
                ? 'Manage your expenses and split bills with friends and family seamlessly. Your financial journey starts here.'
                : 'Join our community to easily track expenses, split bills, and manage shared costs with friends and family. Start simplifying your finances today!'}
            </p>
          </div>
